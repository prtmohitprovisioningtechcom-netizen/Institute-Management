...
export default function BlackPage() {
  ...
  const images = [
    { src: "/University pdf/MU ODL_Fee Structure.jpg", alt: "MU ODL Fee Structure" },
    { src: "/University pdf/MU Online_Fee Structure.jpg", alt: "MU Online Fee Structure" },
    { src: "/University pdf/fee_structure.jpg", alt: "Fee Structure" },
    { src: "/University pdf/fee_structure_pg_diploma.jpg", alt: "Fee Structure PG Diploma" },
  ];
