  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-4xl space-y-6 text-sm leading-8 text-slate-600 sm:text-base sm:leading-9">
        <h2 className="text-2xl font-extrabold text-slate-900">PPDC Government of India</h2>
        <p>
          {brandName} uses PPDC-linked initiatives to promote skill development, vocational learning and practical training for learners seeking better career options.
        </p>
        <p>
