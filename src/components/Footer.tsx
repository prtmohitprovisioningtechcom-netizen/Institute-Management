...
export default function Footer() {
  ...
  const footerAddressLine1 = "H o Subhash vihar delhi";
  const footerAddressLine2 = "R o 14/396 aryanagar firozabad";
    ...
    <>
      ...
      <footer id="contact" className="scroll-mt-28 mt-12 bg-[#767171] text-white sm:scroll-mt-32">
        ...
        <div className="bg-white text-slate-700">
          <div className="bg-[#090995] text-white">
            <div className="mx-auto flex w-full max-w-7xl flex-col items-start justify-between gap-4 px-4 py-7 sm:gap-6 sm:px-6 sm:py-9 md:flex-row md:items-center md:px-10 lg:px-16">
              <div className="max-w-3xl space-y-3">
                <h2 className="text-xl font-extrabold tracking-tight sm:text-2xl">Need More Service?</h2>
                <p className="text-sm leading-6 text-slate-100 sm:text-base sm:leading-7">
                  Need More Services Kindly Contact us or email us.
                </p>
                <p className="text-sm leading-6 text-slate-100 sm:text-base sm:leading-7">
                  We provide Franchises services all over India kindly share your requirements us..
                </p>
              </div>
              <Link
                href="#contact"
          ...
          <div className="overflow-hidden">
            <motion.div
              ...
              transition={prefersReducedMotion ? { duration: 0 } : { duration: bannerCycleDuration, ease: "easeInOut", repeat: Infinity, times: [0, 4.5 / bannerCycleDuration, 1] }}
            >
        ...
        <div className="mx-auto grid w-full max-w-7xl gap-8 px-4 py-10 sm:gap-10 sm:px-6 sm:py-12 md:grid-cols-2 xl:grid-cols-[1.1fr_1fr_1.1fr_1.2fr]">
            ...
            <div className="inline-flex flex-col items-center text-center md:items-start md:text-left">
              <div className="leading-none">
                <div className="flex items-center gap-4">
                  <span className="text-2xl font-black text-white uppercase tracking-tighter">{brandName}</span>
                </div>
              </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-extrabold uppercase tracking-[0.12em] text-white sm:text-xl">Quick Links</h3>
          ...
          {/* Stay With Us */}
          <div>
            <h3 className="text-lg font-extrabold uppercase tracking-[0.12em] text-white sm:text-xl">Stay With Us</h3>
            <div className="mt-4 h-1 w-19 bg-[#13139f]" />
          ...
          {/* Map View */}
          <div>
            <h3 className="text-lg font-extrabold uppercase tracking-[0.12em] text-white sm:text-xl">Map View</h3>
            <div className="mt-4 h-1 w-19 bg-[#13139f]" />
            <div className="mt-6 overflow-hidden border border-white/20 bg-white shadow-lg">
              <iframe
                title={`${brandName} Map`}
                src={`https://maps.app.goo.gl/xbiqVeFAZrZkuVBeA?g_st=awb`}
        ...
        <div className="bg-[#08089d] px-4 py-4 text-white sm:px-6 sm:py-5">
          <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-between gap-2 text-center text-xs font-medium md:flex-row md:text-left sm:text-sm">
            <p>{brandName.toUpperCase()} © {currentYear}</p>
            <p>Designed by <span className="font-bold">{SITE_INFO.designer}</span></p>
          </div>
        </div>
      </footer>
    </>
